...
<<<<<<< HEAD
  geom_smooth(aes(Abatement,MC_A, colour="Sector A"), method=lm, se=FALSE) +
  geom_smooth(aes(Abatement,MC_B,colour="Sector B"), method=lm, se=FALSE) +
  geom_smooth(aes(Abatement,MC_C, colour="Sector C"), method=lm, se=FALSE) +
  geom_smooth(aes(Abatement,MC_D, colour="Sector D"), method=lm, se=FALSE) +
...
>>>>>>> dbde09bc3afceaffd92cbafba8d1b6ea3a1477f5
