...
```
```{r}
sectorA = lm(data = carbon, Abatement~MC_A)
summary(sectorA)
...
lossAi = integrate(SectorADemand, 0, 100)
lossA = sectorA$coefficients[1]*100 + (((sectorA$coefficients[2]*100)+(sectorA$coefficients[1])*(100-sectorA$coefficients[1])*0.5)) 

lossB = sectorB$coefficients[1]*100 + (((sectorB$coefficients[2]*100)+(sectorB$coefficients[1])*(100-sectorB$coefficients[1])*0.5)) 

lossC = sectorC$coefficients[1]*100 + (((sectorC$coefficients[2]*100)+(sectorC$coefficients[1])*(100-sectorC$coefficients[1])*0.5)) 

lossD = sectorD$coefficients[1]*100 + (((sectorD$coefficients[2]*100)+(sectorD$coefficients[1])*(100-sectorD$coefficients[1])*0.5)) 
